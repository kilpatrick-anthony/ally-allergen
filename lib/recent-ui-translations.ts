...
import { deviceManagementTranslations } from '@/lib/device-management-translations'
import { sharedProductionTranslations } from '@/lib/shared-production-translations'
import { authFlowTranslations } from '@/lib/auth-flow-translations'
import { liveDashboardTranslations } from '@/lib/live-dashboard-translations'
...
export const recentUiTranslations = {
  en: {
    ...
    ...deviceManagementTranslations.en,
    ...sharedProductionTranslations.en,
    ...authFlowTranslations.en,
    ...liveDashboardTranslations.en,
  ...
  ga: {
    ...
    ...deviceManagementTranslations.ga,
    ...sharedProductionTranslations.ga,
    ...authFlowTranslations.ga,
    ...liveDashboardTranslations.ga,
  ...
  pt: {
    ...
    ...deviceManagementTranslations.pt,
    ...sharedProductionTranslations.pt,
    ...authFlowTranslations.pt,
    ...liveDashboardTranslations.pt,
  ...
  fr: {
    ...
    ...deviceManagementTranslations.fr,
    ...sharedProductionTranslations.fr,
    ...authFlowTranslations.fr,
    ...liveDashboardTranslations.fr,
  ...
  es: {
    ...
    ...deviceManagementTranslations.es,
    ...sharedProductionTranslations.es,
    ...authFlowTranslations.es,
    ...liveDashboardTranslations.es,
  ...
  de: {
    ...
    ...deviceManagementTranslations.de,
    ...sharedProductionTranslations.de,
    ...authFlowTranslations.de,
    ...liveDashboardTranslations.de,
