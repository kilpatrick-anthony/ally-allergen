...
const rows = [
  ...
  ['tablets', 'Tablets', 'Táibléid', 'Tablets', 'Tablettes', 'Tabletas', 'Tablets'],
  ['displays', 'Displays', 'Scáileáin', 'Ecrãs', 'Écrans', 'Pantallas', 'Anzeigen'],
  ['mobile', 'Mobile', 'Fón Póca', 'Telemóvel', 'Mobile', 'Móvil', 'Mobil'],
  ['onlineOnly', 'Online Only', 'Ar Líne Amháin', 'Apenas online', 'En ligne uniquement', 'Solo en línea', 'Nur online'],
  ['offlineOnly', 'Offline Only', 'As Líne Amháin', 'Apenas offline', 'Hors ligne uniquement', 'Solo sin conexión', 'Nur offline'],
  ['unassigned', 'Unassigned', 'Gan Sannadh', 'Não atribuído', 'Non attribué', 'Sin asignar', 'Nicht zugewiesen'],
  ['manage', 'Manage', 'Bainistigh', 'Gerir', 'Gérer', 'Gestionar', 'Verwalten'],
  ['noDevicesFound', 'No devices found', 'Níor aimsíodh aon ghléasanna', 'Nenhum dispositivo encontrado', 'Aucun appareil trouvé', 'No se encontraron dispositivos', 'Keine Geräte gefunden'],
  ['addDevicesEmpty', 'Add devices to your sites to see them here', 'Cuir gléasanna le do shuíomhanna chun iad a fheiceáil anseo', 'Adicione dispositivos aos seus locais para os ver aqui', 'Ajoutez des appareils à vos sites pour les voir ici', 'Añade dispositivos a tus centros para verlos aquí', 'Fügen Sie Ihren Standorten Geräte hinzu, um sie hier zu sehen'],
  ['never', 'Never', 'Riamh', 'Nunca', 'Jamais', 'Nunca', 'Nie'],
  ['justNow', 'Just now', 'Díreach anois', 'Agora mesmo', 'À l’instant', 'Ahora mismo', 'Gerade eben'],
  ['minutesAgo', '{count}m ago', '{count}n ó shin', 'há {count} min', 'il y a {count} min', 'hace {count} min', 'vor {count} Min.'],
  ['hoursAgo', '{count}h ago', '{count}u ó shin', 'há {count} h', 'il y a {count} h', 'hace {count} h', 'vor {count} Std.'],
  ['daysAgo', '{count}d ago', '{count}l ó shin', 'há {count} d', 'il y a {count} j', 'hace {count} d', 'vor {count} T.'],
  ['closeNavigationMenu', 'Close navigation menu', 'Dún an roghchlár nascleanúna', 'Fechar menu de navegação', 'Fermer le menu de navigation', 'Cerrar menú de navegación', 'Navigationsmenü schließen'],
  ['openNavigationMenu', 'Open navigation menu', 'Oscail an roghchlár nascleanúna', 'Abrir menu de navegação', 'Ouvrir le menu de navigation', 'Abrir menú de navegación', 'Navigationsmenü öffnen'],
  ['adminUser', 'Admin User', 'Úsáideoir Riaracháin', 'Utilizador administrador', 'Utilisateur administrateur', 'Usuario administrador', 'Admin-Benutzer'],
  ['administrator', 'Administrator', 'Riarthóir', 'Administrador', 'Administrateur', 'Administrador', 'Administrator'],
  ['impersonationActive', 'Impersonation mode is active', 'Tá an mód ionadaíochta gníomhach', 'O modo de representação está ativo', 'Le mode d’emprunt d’identité est actif', 'El modo de suplantación está activo', 'Der Identitätswechsel ist aktiv'],
  ['browsingAs', 'You are browsing as {name}.', 'Tá tú ag brabhsáil mar {name}.', 'Está a navegar como {name}.', 'Vous naviguez en tant que {name}.', 'Estás navegando como {name}.', 'Sie navigieren als {name}.'],
  ['businessOwnerFallback', 'this business owner', 'úinéir an ghnó seo', 'este proprietário da empresa', 'le propriétaire de cette entreprise', 'el propietario de esta empresa', 'dieser Unternehmensinhaber'],
  ['originalSuperAdmin', 'Original super admin: {email}.', 'Sár-riarthóir bunaidh: {email}.', 'Superadministrador original: {email}.', 'Super administrateur d’origine : {email}.', 'Superadministrador original: {email}.', 'Ursprünglicher Super-Admin: {email}.'],
  ['returning', 'Returning…', 'Ag filleadh…', 'A regressar…', 'Retour…', 'Volviendo…', 'Rückkehr…'],
  ['returnToSuperAdmin', 'Return to Super Admin', 'Fill ar an Sár-Riarachán', 'Voltar ao superadministrador', 'Retourner au portail super administrateur', 'Volver a Superadministrador', 'Zum Super-Admin zurückkehren'],
